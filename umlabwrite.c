...
extern void print_a_digit(Seq_T stream);
...
extern void build_map_unmap_store_load_test(Seq_T instructions);
extern void build_load_prog_test(Seq_T instructions);
...
static struct test_info {
        ...
        { "conditional-move",     NULL, "", build_conditional_move_test },
        { "nand",                 NULL, "", build_nand_test },
        { "map-unmap-store-load", NULL, "", build_map_unmap_store_load_test },
        { "load-prog",            NULL, "", build_load_prog_test },
        { "input",                NULL, "", build_input_test },
        { "halt-verbose",         NULL, "", build_verbose_halt_test },
        { "print-six",            NULL, "", print_a_digit }
};
