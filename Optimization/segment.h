...
Effects: none 
*/
uint32_t map(Memory memory, int size, Stack IDs);
...
Effects: none 
*/
uint32_t load_word(uint32_t index, uint32_t B, Memory segments);
...
Effects: none 
*/
void store_word(uint32_t index, uint32_t word, uint32_t id, Memory segments);
